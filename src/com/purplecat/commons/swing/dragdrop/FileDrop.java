...
import com.purplecat.commons.swing.dragdrop.FileDrop.TransferableObject;
                ...
                {   log( out, "FileDrop: drop event." );
                    ...
                    {   // Get whatever was dropped
                        ...
                        if (tr.isDataFlavorSupported (java.awt.datatransfer.DataFlavor.javaFileListFlavor))
                        {
                            ...
                            // Get a useful list
                            Object obj = tr.getTransferData(java.awt.datatransfer.DataFlavor.javaFileListFlavor);
                            if ( obj instanceof java.util.List<?> ) {
                            	java.util.List<?> fileList = (java.util.List<?>)obj;
                        ...
                        else if ( tr.isDataFlavorSupported( java.awt.datatransfer.DataFlavor.stringFlavor )) {
                        	evt.acceptDrop( java.awt.dnd.DnDConstants.ACTION_COPY );
                        	log( out, "FileDrop: string accepted.");
                        	Object obj = tr.getTransferData(java.awt.datatransfer.DataFlavor.stringFlavor);
                        	if ( obj instanceof String && listener != null ) {
                        		listener.stringDropped(c, (String)obj);
                        	}
                        }
                        else // this section will check for a reader flavor.
                        {
                            ...
                            for (int zz = 0; zz < flavors.length; zz++) {
                                if (flavors[zz].isRepresentationClassReader()) {
                                    ...
                                    if(listener != null)
                                        listener.filesDropped(c, createFileArray(br, out));
                                ...
                                else if ( flavors[zz].equals(DragDropHandler.sgLocalArrayListFlavor)) {
                                    evt.acceptDrop(java.awt.dnd.DnDConstants.ACTION_MOVE);
                                    log(out, "FileDrop: array-object accepted.");
                                	Object obj = tr.getTransferData(DragDropHandler.sgLocalArrayListFlavor);
                                    if(listener != null && obj instanceof List)
                                        listener.listDropped(c, (List<?>)obj);
//                                	evt.acceptDrop( java.awt.dnd.DnDConstants.ACTION_MOVE );
//                                	log( out, "handling sgLocalArrayListFlavor drag/drop, move action");
//                                	DebugUtils.printclass(true, "obj class: ", obj);
//                                	DebugUtils.println(true, "obj data: " + obj);
                                    evt.getDropTargetContext().dropComplete(true);
                                    log(out, "FileDrop: drop complete.");
                                	handled = true;
                                }
    ...
    {   // Static Boolean
        ...
        {   
            ...
            try {
            	Class.forName( "java.awt.dnd.DnDConstants" ); //  Class<?> arbitraryDndClass = 
                support = true;
            }   // end try
        ...
        try { 
            ...
            while ((line = bReader.readLine()) != null) {
                try {
                    ...
                    log(out, "URI Syntax Error with " + line + ": " + ex.getMessage());
                }
            }
    ...
    {   boolean ok = false;
        ...
        {   
            ...
            // END 2007-09-12 Nathan Blomquist -- Linux (KDE/Gnome) support added.
            //CJTEST my flavor addition
            else if ( curFlavor.equals( java.awt.datatransfer.DataFlavor.stringFlavor ) ) {
            	ok = true;
            }
            else if ( curFlavor.equals(DragDropHandler.sgLocalArrayListFlavor) ) {
            	log( out, "curFlavor equals sgLocalArrayListFlavor" );
            	ok = true;
            }
            //END CJTEST addition
            i++;
...
/* ********  I N N E R   I N T E R F A C E   L I S T E N E R  ******** */    
    ...
    public static interface Listener {
         ...
         * @since 1.0
         */
        public abstract void filesDropped( java.awt.Component c, java.io.File[] files );
        public abstract void objectDropped( java.awt.Component c, Transferable obj);
		public abstract void stringDropped( java.awt.Component c, String s );
        public abstract void listDropped( java.awt.Component c, List<?> list);
